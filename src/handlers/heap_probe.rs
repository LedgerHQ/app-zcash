...
use crate::AppSW;
use crate::consts::{MAX_PCZT_IRONWOOD_ACTIONS_NUMBER, MAX_PCZT_ORCHARD_ACTIONS_NUMBER};
...
///
/// Layout: largest free block as a big-endian `u32`, then the Orchard and Ironwood action bounds as
/// big-endian `u16`s.
///
