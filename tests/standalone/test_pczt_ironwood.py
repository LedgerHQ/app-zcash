...
def test_pczt_ironwood_v3_real_output_accepted(
    ...
    """
    # Generated by the `gen_v3_ironwood_test_vectors` test in vendor/orchard/src/note_encryption.rs.
    # esk = note.esk() = PRF-esk(rseed, rho) so the device's derived_epk check passes.
    _V3_REAL_EPK = bytes.fromhex(
        "f4232b9b6e17f52b6d5bbdc2b8aeebd6440966d3f15376dbb31fee16f3840f27"
    )
    _V3_REAL_CMX = bytes.fromhex(
        "f355e2fceb8d2c79282f01439274efb233ca449253740e60d1249eadaa048c0b"
    )
