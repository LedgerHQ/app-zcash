...
def test_pczt_sign_tx_v5_transparent_to_orchard_simple(
    ...
    ORCHARD_BUNDLE = PcztOrchardBundle(
        actions=[
            PcztOrchardAction(
                ...
                rk=bytes.fromhex("de43004dfe82c370356e830569bc2136374339101ab3170a9e5f01da03463401"),
            ...
            PcztOrchardAction(
                ...
                rk=bytes.fromhex("4493fd132958cdabfbb6985d998ab1c00ac66861552116d0b3dc27a86ff398b9"),
    ...
    PCZT_GLOBAL = PcztGlobal()
    EXPECTED_AUTH_SIG = bytes.fromhex("37E6B2A1EE7BFE2C2998B370DF4E8B8F7748EF5A30FB9F543319AC2C817858832562539327E578B15D8868B4049B0E7F7599CE52C946A0B8823561846A4C8D24")
...
def test_pczt_sign_tx_v5_transparent_to_orchard_with_change(
    ...
    ORCHARD_BUNDLE = PcztOrchardBundle(
        actions=[
            PcztOrchardAction(
                ...
                nullifier=bytes.fromhex("3768e7c28954fec9791e472e02881cb6b2c3f6d744c4eeb0f248eef01f6fb53d"),
                rk=bytes.fromhex("306050373d1a6fb3c4bd05888e2a900c1c81948d0653c90ea957fd43afd3a3b1"),
            ...
            PcztOrchardAction(
                ...
                nullifier=bytes.fromhex("9f2daa682b1a9ce8c102ea6504c18be633d23429b3625c42005fa15d4597632a"),
                rk=bytes.fromhex("422d852b786b80b97a198b58784c20e3d6f7a12562f9b6cefb1b8c30ebf231a6"),
    ...
    PCZT_GLOBAL = PcztGlobal()
    EXPECTED_AUTH_SIG = bytes.fromhex("E0184B4224DBA7153C2394B60DAF6D1E8926ACF7AA484D979DA2B14D62F3CFBBD5C3D5D607DB71C331AFB04ED4984DA26F4E2B41A1373F10C21E7A98D6C77008")
...
def test_pczt_sign_tx_v5_orchard_to_transparent_simple(
    ...
    ORCHARD_BUNDLE = PcztOrchardBundle(
        actions=[
            PcztOrchardAction(
                ...
                rk=bytes.fromhex("3ff6805f58f687f59c1b5c3cc2c022642f5c20fbf46ba9ccef045770a7e04f80"),
            ...
            PcztOrchardAction(
                ...
                rk=bytes.fromhex("16ce121283e430b7c95be852155b347b3656e520627f40582e13f971bf3119a6"),
    ...
    PCZT_GLOBAL = PcztGlobal()
    EXPECTED_AUTH_SIG = bytes.fromhex("DECD861FEEB30AD2990A2E3F9F5BAA64F6B22FFEBC967A352B0827D1687B943AB961193274C1BBB281DE9C167E4096BE94649934AD6CC9386F2718EC5B73201B")
...
def test_pczt_sign_tx_v5_orchard_to_transparent_with_change(
    ...
    ORCHARD_BUNDLE = PcztOrchardBundle(
        actions=[
            PcztOrchardAction(
                ...
                nullifier=bytes.fromhex("d68f3363b4843cb568dedbf4d966d1d7876a2edfd758d126efe1a8bd1836620f"),
                rk=bytes.fromhex("b349d7cef117ee3c00a5b3f04688064df7384ee69e9996c0b99393dc26ba2bb0"),
            ...
            PcztOrchardAction(
                ...
                nullifier=bytes.fromhex("ad55957c9deceaee264e52a66c4aff7d5a9100f88c36cb9f1ef39726ab440006"),
                rk=bytes.fromhex("cb487269f6ff211f30c951e3c530546990d7a2ac2728f76415079b8c3b6bcd83"),
    ...
    PCZT_GLOBAL = PcztGlobal()
    EXPECTED_AUTH_SIG = bytes.fromhex("8A3D7A647F5C972CCD505A6178737DC4DBE4CA8EB0C29F805024D3B7704C5287832820773FF1B0B1730AADB4B53BFF4A1CEA886895EB9E6566B82D317885A72A")
...
def test_pczt_sign_tx_v5_orchard_to_transparent_with_transparent_change(
    ...
    PCZT_GLOBAL = PcztGlobal()
    EXPECTED_AUTH_SIG = bytes.fromhex("57893704B370D5E50515A71666D682FD4F20C269BAEC612966273EAA1CB850165267ADD6A1CC2F065611DB5A1806FC8ED65723EA74680C20D50C443120D84438")
...
def test_pczt_sign_tx_v5_orchard_to_orchard_simple(
    ...
    ORCHARD_BUNDLE = PcztOrchardBundle(
        actions=[
            PcztOrchardAction(
                ...
                rk=bytes.fromhex("7066f527f7fe9c4ec6d4c57bf76d6851db115b60d707a2e49b12a92d0248b707"),
            ...
            PcztOrchardAction(
                ...
                rk=bytes.fromhex("47172d229822aa14a6bffe3405ab48f4e8d14f27c5b286be6c4e95f2a00e5abe"),
    ...
    PCZT_GLOBAL = PcztGlobal()
    EXPECTED_AUTH_SIG = bytes.fromhex("C88E89A717C3785083585B3F3C394B964AE41A5C6AE662D813CF2F31D6593C3782E6007F833BB0BD4EDAA7D594E6BC9813C25C3176B1B71BFD184F5E9E21DC2C")
...
def test_pczt_sign_tx_v5_orchard_to_orchard_with_change(
    ...
    ORCHARD_BUNDLE = PcztOrchardBundle(
        actions=[
            PcztOrchardAction(
                ...
                nullifier=bytes.fromhex("fc3ea087e60269ff25114682610a6b0d716f191fbf2acf767d2de63de4b95a00"),
                rk=bytes.fromhex("94fd0a5cd314b70ef0576cef0dd21bd9a4d3919ac801e7199fa1b8be6bd6f3b2"),
            ...
            PcztOrchardAction(
                ...
                nullifier=bytes.fromhex("d68cef8d52a164d092d8bd4a616458187f7703ce6ce5ee9ded3fde2df4c56912"),
                rk=bytes.fromhex("2d62ebc4f70e798fad2fff9b7873cdd476cbb3ca1623943b7ba69732295378a5"),
    ...
    PCZT_GLOBAL = PcztGlobal()
    EXPECTED_AUTH_SIG = bytes.fromhex("1030F56867C7A68BC40AEFA9E34DD7A1C8B29BF2894DD1D82EDC083CE620CC9BD02F30AE1665AFAB46EA0B574B89D376F046C87EA8B1CC6B5B89763F56AB0B1B")
