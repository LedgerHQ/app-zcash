...
def test_sign_tx_v5_transparent_to_orchard_with_change(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("4D6D53AE2BEEA960AF05C76DDAD54064C64F194BD78FB6E71E4944DD36801B3AF4458F9223B372FD3E2A3D34A78D9182BBA9CB9E502DCE3135535724D3D0F31D")
...
def test_sign_tx_v5_orchard_to_transparent_simple(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("588E331C76ED2FD972984D6FD6E61EB9DB2E0A7E35EB331EB90962ECEDE3133A2B193DB8FA727846E374B61885749425AFBF52A2A821D082BFF3A375055E9F15")
...
def test_sign_tx_v5_orchard_to_transparent_with_change(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("815A3708E88CACB99CFBD4CF900AB5DAED992D5D3D588075D76FAF91138655327057461F27BFE28724DA079C3C89B8C8CEDE89672304E00AF75FC2F054C85F3B")
    _assert_real_orchard_only_sign_digest(
        backend,
        scenario_navigator,
        TX_STR,
...
def test_sign_tx_v5_orchard_to_transparent_with_transparent_change(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("7C32BAF98AEEE05AF84F941818E4597A2FBCE88DBA37A4B7B5B8847C628D1A1C3797F74B7E1CC165939FAA46F4C8B47B9902B317876FB395502DBA0620E94E01")
    _assert_real_orchard_only_sign_digest(
        backend,
        scenario_navigator,
        TX_STR,
...
def test_sign_tx_v5_orchard_to_orchard_simple(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("1225F5B990AC08B839653823D8550CBBA8501F510CFD6A2384E20DDEB17B12027E0E37B4F0C5E46B41B535429A77B78F1666B48036D8B829A8D4F7CCCCD0DB1E")
    _assert_real_orchard_only_sign_digest(
        backend,
        scenario_navigator,
        TX_STR,
...
def test_sign_tx_v5_orchard_to_orchard_with_change(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("20A302B21A9AC5511CBE867005B83AA8BF27EB68F9FBBCC3AB3A774DC75FC008D1A6215C59D8ED253FFC81F26CA67413B42ADB14C2EEAD1CFC70C0388275A20C")
    _assert_real_orchard_only_sign_digest(
        backend,
        scenario_navigator,
        TX_STR,
