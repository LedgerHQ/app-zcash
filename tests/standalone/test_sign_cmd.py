...
def test_sign_tx_v5_orchard_to_transparent_real(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("1B0A863486015AF57A8536943388E0672814BE9BF50925444E383124122B748CFDA9403EDD5A4AA0A525B6D4EDBBB473134114362ABE111F3A73897127C21428")
...
def test_sign_tx_v5_orchard_to_transparent_with_change(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("E934DF0D7913AE327299CBAED226B6A2956A58A345C0763416AE305E7644BB21EE83B1183435DBFFAADA4040B094D2BDCF00BA830D5C0EEA830B2E852674E520")
    _assert_real_orchard_only_sign_digest(backend, scenario_navigator, TX_STR, EXPECTED_AUTH_SIG)
