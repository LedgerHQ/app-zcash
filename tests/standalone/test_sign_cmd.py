...
def test_sign_tx_v5_change(backend, scenario_navigator):
    ...
    with client.hash_input(transaction=TX_BYTES, trusted_inputs=[trusted_input], change_or_shielded_path=change_path):
        scenario_navigator.review_approve()
...
def test_sign_tx_v5_transparent_to_orchard_simple(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("56DDBE2F1512F9F0A038F435B5BCBC3DEC75B54347DB1EDD3E149F516B91F8B79AA3F435862F77AEF7BE5D334196ED4C44389CD4DA9A473CA7AB9A9C08C6A22D")
...
def test_sign_tx_v5_transparent_to_orchard_with_change(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("1B3A31634A0424044389256DBCA0D563824CA11FFDCB7EF0585E66C0DE9A1E861C12CFB414B2A7B3ABF61A728BF696B46D5ABEA9C62D09F2B3FEFA069AC89C32")
...
def test_sign_tx_v5_orchard_to_transparent_simple(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("4B0BC7A8C4353F9B10F1A6FA309A079A3599A5C942C57A6769F721263674B702E885BE455ED6926B90CD54C406DEA2072456251F9E9B074A4CE3AA890BED3D0D")
...
def test_sign_tx_v5_orchard_to_transparent_with_change(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("FE32D099B7C4198083B82C4ED97F168B44D0A76D395834A316EEE5AD3785892EF45D15727D41AEA0D5FCDF0A1DFC3AE1418E6770EBBC1D1E516D6BB67EF2CF38")
    _assert_real_orchard_only_sign_digest(
        backend,
        scenario_navigator,
        TX_STR,
...
def test_sign_tx_v5_orchard_to_transparent_with_transparent_change(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("965388DA6CF71F61E7A9A114BBD022D1410A34558FD1C88CBBEF370250AF66BCAF5F74F543BBD9888BB7FA0F4F09119DA01522B0B3723065046C8D1823C1CD36")
    _assert_real_orchard_only_sign_digest(
        backend,
        scenario_navigator,
        TX_STR,
...
def test_sign_tx_v5_orchard_to_orchard_simple(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("6F1D0C15CFAAC4DF766D3946BD4E16D62599F06264E9005D7831DD999BC6660003642BBAEF3B9266DF23EAD8A49A15EC7A06B6213C877164802A8F8B278E6317")
    _assert_real_orchard_only_sign_digest(
        backend,
        scenario_navigator,
        TX_STR,
...
def test_sign_tx_v5_orchard_to_orchard_with_change(backend, scenario_navigator):
    ...
    EXPECTED_AUTH_SIG = bytes.fromhex("F1C4F455ECED5DAD4865BEDCDF1B41B694F71D3F90B6B05B6FEB77EFD415A50F2A43C42DE6FA030FC48F2A92A218DF5DFF5845CC234D606FE7307B7D2368D508")
    _assert_real_orchard_only_sign_digest(
        backend,
        scenario_navigator,
        TX_STR,
